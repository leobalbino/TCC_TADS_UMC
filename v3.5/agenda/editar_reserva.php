	...
	<div class="container" id="tamanhoContainer">
		...
		<form action="atualizar_reserva.php" method="post" style="margin-top: 20px">
			...
			<div class="form-group">
	    		<label>Id</label>
	    		<input type="number" class="form-control" name="IdReserva" value="<?php echo $IdReserva ?>"   disabled="">	
	    		<input type="number" class="form-control" name="id"  display = "none" value="<?php echo $id ?>" >	
  			</div>
