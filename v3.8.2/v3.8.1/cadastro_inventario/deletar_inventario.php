...
$sql = "DELETE FROM `inventario` WHERE `IdProduto` = $id";
...
<div id="tamanhoContainer" class="container" style="margin-bottom: 30px;">
	...
	<center>
		...
		<center>
			<h4 style="color: red">Excluído com sucesso!</h4>	
	</center>
</div>
