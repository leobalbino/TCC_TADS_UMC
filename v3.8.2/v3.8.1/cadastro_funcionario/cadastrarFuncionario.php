		...
		<form action="inserir_funcionario.php" method="post" style="margin-top: 20px">
			...
			<div class="row">
		  	...
		  	<div class="form-group" style="margin-top: 10px;">
			    ...
			    <input type="number" class="form-control" name="RACoordenadorResponsavel" placeholder="Insira o RA do Coordenador Responsável" maxlength="11" size="11" min="1" step="1" required>
			    <small id="Turmaobs" class="form-text text-muted">Somente números.</small>
		  	</div>
