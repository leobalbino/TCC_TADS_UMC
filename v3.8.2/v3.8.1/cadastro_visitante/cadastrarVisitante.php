	...
	<div class="container" id="tamanhoContainer">
		...
		<form action="inserir_visitante.php" method="post" style="margin-top: 20px; ">
			...
			<div class="row">
				<div class="col-sm-6">
	    			<label>Id </label>
	    			<input type="number" class="form-control" name="IdVisit" placeholder="Campo automático" disabled>
	    		</div>	
  			</div>

	 		<div class="col-sm-6">
	    		<label>CPF</label>  		
	    		<input type="number" class="form-control" name="CPFVisitante"  maxlength="11" size="11" min="1" step="1"  required>	
		  	...
		  	<div class="row">
				<div class="col-sm-6">
			    	...
			    	<input type="number" class="form-control" name="TelefoneVisitante" maxlength="9" size="9" min="1" step="1" required>
			    	 <small id="Turmaobs" class="form-text text-muted">Sem DD. Somente números</small>
				</div>
