	...
	<div class="container" id="tamanhoContainer">
		...
		<form action="inserir_funcionario.php" method="post" style="margin-top: 20px">
	 		<div class="form-group">
	    		<label>CPF</label>
	    		<input type="number" class="form-control" name="CPF" placeholder="Insira o CPF"  maxlength="11" size="11" min="1" step="1" required>	
		  	...
		  	<div class="form-group">
			    <label>Turma</label>
			    <input type="text" class="form-control" name="Turma" placeholder="Insira a Turma" required>
