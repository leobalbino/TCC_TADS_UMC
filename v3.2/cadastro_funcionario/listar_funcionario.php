		  ...
		  <thead>
		    ...
		    <tr>	
			  ...
			  <td>
    			...
    			if ($Cargo == 3) {
   				?>
			  	<a class="btn btn-warning btn-sm"  style="color: #fff" href="editar_funcionario.php?cpf=<?php echo $CPF ?>" role="button"><i class="fas fa-edit"></i>&nbsp;Editar</a> <!--&nbsp:  espaço/ tag php ai dentro: passa id pelo link-->

			  	<a class="btn btn-danger btn-sm" onclick="return confirm('Deseja excluir ?')" style="color: #fff" href="deletar_funcionario.php?cpf=<?php echo $CPF ?>" role="button"><i class="far fa-trash-alt"></i>&nbsp;Excluir</a>
			  	<?php } ?> <!--fim permissão -->
			  </td>
			 </tr>
