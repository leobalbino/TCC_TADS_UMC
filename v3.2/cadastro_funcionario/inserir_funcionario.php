...
$sql = "INSERT INTO `funcionarios`(`CPF`, `Login`, `Senha`, `RA`, `Nome`, `Turma`, `Cargo`, `RACoordenadorResponsavel`) VALUES ($CPF, '$Login', sha1('$Senha'), $RA, '$Nome', '$Turma', $Cargo, $RACoordenadorResponsavel)";
