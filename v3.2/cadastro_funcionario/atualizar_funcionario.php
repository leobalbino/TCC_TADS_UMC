...
$sql = "UPDATE `funcionarios` SET `Login`= '$Login' ,`Senha`= '$Senha',`RA`= $RA,`Nome`= '$Nome',`Turma`='$Turma',`Cargo`= '$Cargo', `RACoordenadorResponsavel` =  $RACoordenadorResponsavel WHERE CPF = $cpf";
