...
include 'conexao.php';
	...
	$sql = "UPDATE `visitante` SET `NomeVisitante`= '$NomeVisitante' ,`EnderecoVisitante`= $EnderecoVisitante,`InstituicaoVisitante`='$InstituicaoVisitante',`TelefoneVisitante`= $TelefoneVisitante,`QntAlunosVisita`= $QntAlunosVisita WHERE CPFVisitante = $cpf ";
