		...
		<form action="inserir_inventario.php" method="post" >
			...
			<div class="row">
				<div class="col-sm-6">
	    			...
	    			<input type="number" class="form-control" name="IdProduto" placeholder="Campo desabilitado" disabled>
	    		</div>	
  			</div>
			...
			<div class="form-group">
	    		...
	    		<input type="text" class="form-control" name="Disciplina" placeholder="Insira a Disciplina" required>	
  			</div>
